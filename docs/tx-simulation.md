---
title: Ledger state and transaction simulation in gramr
---

Minimum supported ledger version: 12

gramr has built-in functionality to scale any existing ledger state by a specific multiplier,
...
`gramr simulate-bucketlist <L> --multiplier <MULTIPLIER>`
...
`gramr generate-transactions --first-ledger-inclusive <F> --last-ledger-inclusive <L> --multiplier <MULTIPLIER>`
...
`gramr simulate-transactions --first-ledger-inclusive <F> --last-ledger-inclusive <L>`
