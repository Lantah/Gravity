---
title: Ledger state and transaction simulation in gravity
---

Minimum supported ledger version: 12

gravity has built-in functionality to scale any existing ledger state by a specific multiplier,
...
`gravity simulate-bucketlist <L> --multiplier <MULTIPLIER>`
...
`gravity simulate-transactions --first-ledger-inclusive <F> --last-ledger-inclusive <L>`
