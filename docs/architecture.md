...
- Set of core validator nodes. Running gravity only. Tasked with:
...
- Set of public HTTP nodes. Not running gravity. Running
...
- (optional): Set of public validator nodes. Running gravity only. Tasked
with:
