...
Note that you can (and should) install the Windows version of postgres even when running gravity from within WSL.


# Basic Installation

- `git clone PATH_TO_GRAVITY`
- `git submodule init`
- `git submodule update`
- Open the solution `Builds\VisualStudio\gravity.sln`
